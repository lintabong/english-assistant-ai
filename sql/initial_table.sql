...
CREATE TABLE conversation_items (
    id INT AUTO_INCREMENT PRIMARY KEY,
    set_id INT NOT NULL,
    path VARCHAR(255),            -- path ke file audio/text
    content TEXT,                 -- isi pertanyaan/percakapan
    created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
    updated_at DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE user_conversation_logs (
    ...
    score INT DEFAULT NULL,                  -- kalau ada sistem penilaian
...
INSERT INTO user_config (user_id, config_type, config_key, config_value)
VALUES ('68a5492849e41238f450c620', 'conversation', 'active_set', '1');